...
enum SingingCharacter { typeA, typeB,typeC }
...
SingingCharacter _character = SingingCharacter.typeA;
    ...
    return [
      ...
      children: <Widget>[
        RadioListTile<SingingCharacter>(
          title: const Text('TypeA'),
          value: SingingCharacter.typeA,
        ...
        RadioListTile<SingingCharacter>(
          title: const Text('TypeB'),
          value: SingingCharacter.typeB,
          groupValue: _character,
          onChanged: (SingingCharacter value) {
            setState(() {
              _character = value;
         ...
         RadioListTile<SingingCharacter>(
          title: const Text('TypeC'),
          value: SingingCharacter.typeC,
          groupValue: _character,
          onChanged: (SingingCharacter value) {
            setState(() {
              _character = value;
